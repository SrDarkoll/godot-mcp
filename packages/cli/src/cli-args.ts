...
export interface ParsedCommand {command:Command;projectRoot:string;godotBin:string|null;bridgePort?:number;toolProfile?:ToolProfile;client?:ClientName;json:boolean;limit:number;before?:string;sessionId?:string;}
