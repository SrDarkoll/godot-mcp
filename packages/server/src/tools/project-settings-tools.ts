...
export async function getProjectSetting(
  ...
  return await rpc.call('project.settings.get', params as unknown as Record<string, unknown>) as ProjectSettingGetResult;
}
...
export async function setProjectSetting(
  ...
  return await rpc.call('project.settings.set', params as unknown as Record<string, unknown>) as ProjectSettingSetResult;
}
...
export async function listInputActions(
  ...
  return await rpc.call('project.input.list', params as unknown as Record<string, unknown>) as InputListResult;
}
...
export async function addInputAction(
  ...
  return await rpc.call('project.input.add_action', params as unknown as Record<string, unknown>) as InputAddActionResult;
}
...
export async function removeInputAction(
  ...
  return await rpc.call('project.input.remove_action', params as unknown as Record<string, unknown>) as InputRemoveActionResult;
}
