...
. (Join-Path $PSScriptRoot 'verified-godot-version.ps1')
$version = '4.6.3'
...
$executable = Join-Path $target "Godot_v$version-stable_win64_console.exe"
$reported = Get-VerifiedGodotVersion -Executable $executable -ExpectedVersion $version
