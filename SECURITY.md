...
There is no stable security-support/LTS release yet. See CHANGELOG.md and the audit execution plan for the worktree's implementation status. A clean dependency scan is not proof that project code or reflective automation is safe.
